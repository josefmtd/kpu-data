...
cleanNolSatuNasional = cleanNolSatuAceh + cleanNolSatuBali + cleanNolSatuBanten + cleanNolSatuBengkulu + cleanNolSatuDaerahIstimewaYogyakarta + cleanNolSatuDaerahKhususIbukotaJakarta + cleanNolSatuGorontalo + cleanNolSatuJambi + cleanNolSatuJawaBarat + cleanNolSatuJawaTengah + cleanNolSatuJawaTimur + cleanNolSatuKalimantanBarat + cleanNolSatuKalimantanSelatan + cleanNolSatuKalimantanTengah + cleanNolSatuKalimantanTimur + cleanNolSatuKalimantanUtara + cleanNolSatuKepulauanBangka + cleanNolSatuKepulauanRiau + cleanNolSatuLampung + cleanNolSatuMaluku + cleanNolSatuMalukuUtara + cleanNolSatuNusaTenggaraBarat + cleanNolSatuNusaTenggaraTimur + cleanNolSatuPapua + cleanNolSatuPapuaBarat + cleanNolSatuRiau + cleanNolSatuSulawesiBarat + cleanNolSatuSulawesiSelatan + cleanNolSatuSulawesiTengah + cleanNolSatuSulawesiTenggara + cleanNolSatuSulawesiUtara + cleanNolSatuSumateraBarat + cleanNolSatuSumateraSelatan + cleanNolSatuSumateraUtara
cleanNolDuaNasional = cleanNolDuaAceh + cleanNolDuaBali + cleanNolDuaBanten + cleanNolDuaBengkulu + cleanNolDuaDaerahIstimewaYogyakarta + cleanNolDuaDaerahKhususIbukotaJakarta + cleanNolDuaGorontalo + cleanNolDuaJambi + cleanNolDuaJawaBarat + cleanNolDuaJawaTengah + cleanNolDuaJawaTimur + cleanNolDuaKalimantanBarat + cleanNolDuaKalimantanSelatan + cleanNolDuaKalimantanTengah + cleanNolDuaKalimantanTimur + cleanNolDuaKalimantanUtara + cleanNolDuaKepulauanBangka + cleanNolDuaKepulauanRiau + cleanNolDuaLampung + cleanNolDuaMaluku + cleanNolDuaMalukuUtara + cleanNolDuaNusaTenggaraBarat + cleanNolDuaNusaTenggaraTimur + cleanNolDuaPapua + cleanNolDuaPapuaBarat + cleanNolDuaRiau + cleanNolDuaSulawesiBarat + cleanNolDuaSulawesiSelatan + cleanNolDuaSulawesiTengah + cleanNolDuaSulawesiTenggara + cleanNolDuaSulawesiUtara + cleanNolDuaSumateraBarat + cleanNolDuaSumateraSelatan + cleanNolDuaSumateraUtara
cleanTotalSuaraNasional = cleanTotalSuaraAceh.tolist() + cleanTotalSuaraBali.tolist() + cleanTotalSuaraBanten.tolist() + cleanTotalSuaraBengkulu.tolist() + cleanTotalSuaraDaerahIstimewaYogyakarta.tolist() + cleanTotalSuaraDaerahKhususIbukotaJakarta.tolist() + cleanTotalSuaraGorontalo.tolist() + cleanTotalSuaraJambi.tolist() + cleanTotalSuaraJawaBarat.tolist() + cleanTotalSuaraJawaTengah.tolist() + cleanTotalSuaraJawaTimur.tolist() + cleanTotalSuaraKalimantanBarat.tolist() + cleanTotalSuaraKalimantanSelatan.tolist() + cleanTotalSuaraKalimantanTengah.tolist() + cleanTotalSuaraKalimantanTimur.tolist() + cleanTotalSuaraKalimantanUtara.tolist() + cleanTotalSuaraKepulauanBangka.tolist() + cleanTotalSuaraKepulauanRiau.tolist() + cleanTotalSuaraLampung.tolist() + cleanTotalSuaraMaluku.tolist() + cleanTotalSuaraMalukuUtara.tolist() + cleanTotalSuaraNusaTenggaraBarat.tolist() + cleanTotalSuaraNusaTenggaraTimur.tolist() + cleanTotalSuaraPapua.tolist() + cleanTotalSuaraPapuaBarat.tolist() + cleanTotalSuaraRiau.tolist() + cleanTotalSuaraSulawesiBarat.tolist() + cleanTotalSuaraSulawesiSelatan.tolist() + cleanTotalSuaraSulawesiTengah.tolist() + cleanTotalSuaraSulawesiTenggara.tolist() + cleanTotalSuaraSulawesiUtara.tolist() + cleanTotalSuaraSumateraBarat.tolist() + cleanTotalSuaraSumateraSelatan.tolist() + cleanTotalSuaraSumateraUtara.tolist()
